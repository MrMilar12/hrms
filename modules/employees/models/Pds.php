...
class Pds extends Model
{
    ...
    private array $singleRowFields = [
        'personal_info' => [
            ...
            'dual_citizenship_country', 'gsis_no', 'pagibig_no', 'philhealth_no', 'sss_no', 'tin_no',
            'agency_employee_no', 'telephone_no', 'mobile_no', 'email',
        ],
        'family_background' => [
        ...
        'questionnaire' => [
            ...
            'q35a_found_guilty_admin_case', 'q35a_details', 'q35b_criminal_charged', 'q35b_details',
